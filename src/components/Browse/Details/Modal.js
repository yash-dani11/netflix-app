...
const Modal = () => {
  ...
  if(!id) return
  return (
    <><div className="fixed inset-0 flex justify-center items-center z-50 bg-black bg-opacity-60 pt-20">
    ...
    <div className='overflow-x-hidden h-2/5'><div className="relative pb-[56.25%] pt-24 sm:pt-6 w-[300%] left-[-100%] rounded-lg" ref={videoRef}>
    {youtubeId && (
      <iframe
